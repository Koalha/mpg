...
b <- 1:5 # same for b
plot(x=x,y=y) # plot the relationship of a and b
```
...
## Integer and numeric
We have already created one numeric and one integer object. You can check the type and structure of objects wit the command `str()`
...
```{r}
## create a new data frame with variables 'name' and 'species'
